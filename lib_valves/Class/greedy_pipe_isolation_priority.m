classdef greedy_pipe_isolation_priority < handle
    ...
    methods
        ...
        function Run(obj)
            log_file = ['greedy','_Run_debug_.','log'];
            ...
            for i = 1: obj.n_break_pipe
                ...
                obj.output_inp_file{i} = [obj.out_dir,'_isolate_',the_current_break_id,'.inp'];
...
%                 obj.output_system_serviceability(i,1) = sum(cal_demand_chosen_node)/sum(req_demand_chosen_node);
...
%             current_system_serviceablity = sum(cal_demand_chosen_node)/sum(req_demand_chosen_node);
            [current_system_serviceablity] = calculate_SSI(cal_demand_chosen_node,req_demand_chosen_node);
