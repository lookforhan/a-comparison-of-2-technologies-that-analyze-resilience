...
for timeStep_i=1:timeStep_end
    ...
    output_net_filename_n =['.\results\',num2str(timeStep_i),'.inp'];
    output_net_rpt = ['.\results\',num2str(timeStep_i),'.rpt'];
    output_net_pdd_file_n = ['.\results\','pdd_',num2str(timeStep_i)];
