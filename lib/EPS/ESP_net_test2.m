function [ Pressure,Demand,Pattern,Length,system_L_cell,system_serviceability_cell,node_serviceability_cell] = ESP_net_test2( output_net_filename_inp,MC_simulate_result_dir,PipeStatus,pipe_relative,net_data,...
