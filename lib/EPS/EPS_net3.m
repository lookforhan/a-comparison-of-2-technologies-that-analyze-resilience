function [ errcode,Pressure,Demand,Length,system_L_cell,system_serviceability_cell,node_serviceability_cell,TimeStep,activity_cell] = EPS_net3( output_net_filename_inp,output_result_dir,PipeStatus,PipeStatusChange,pipe_relative,net_data,...
...
fid =fopen([output_result_dir,'EPS_net2记录.txt'],'w');
% fid = 1;
if mid_t_l == 0
