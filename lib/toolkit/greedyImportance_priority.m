...
for i = 1:numel(break_pipe_id)  
    ...
    dynamic_importance = (system_s-mid_class.current_system_serviceablity)./isolation_time_mat;
...
for j = 1:numel(recovery_pipe_id)
    ...
    dynamic_recovery_importance = (system_s-mid_recovery_class.current_system_serviceablity)./recovery_time_mat;  
