...
for generation_i = 1:generation_Nmax
    ...
    if ~isempty(pop_recovery_uniq)
        [Fit_recovery_uniq,fitvalue_recovery]=calfitvalue4_recovery(pop_recovery_uniq,damage_pipe_info{1},RepairCrew,...
            Dp_Inspect_mat,Dp_Repair_mat,Dp_Travel_mat,...
            crewStartTime,crewEfficiencyRecovery,crewEfficiencyIsolation,crewEfficiencyTravel,...
            damage_pipe_info,net_data,...
            EPA_format,...
    ...
    if generation_i==1
        ...
        Fit_init(locb1) = Fit_recovery_uniq;
        Fit_init(locb2) = Fit_record(locb3);
        Fit_record = [Fit_record;Fit_init];
    ...
    [lia1,locb1] = ismember(pop_uniq_recovery,newPop_recovery,'rows');
    [lia2,locb2] = ismember(pop_uniq_not_recovery,newPop_recovery,'rows');
    [lia3,locb3] = ismember(pop_uniq_not_recovery,pop_recovery_record,'rows');
...
function [Fit,fitvalue]=calfitvalue4_recovery(pop,BreakPipe_order,RepairCrew,...
    Dp_Inspect_mat,Dp_Repair_mat,Dp_Travel_mat,...
    crewStartTime,crewEfficiencyRecovery,crewEfficiencyIsolation,crewEfficiencyTravel,...
    ~,net_data,...
    ~,...
