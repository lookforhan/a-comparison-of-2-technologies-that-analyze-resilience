...
%}
function [fitvalue,best_pop]=calfitvalue(pop,RepairCrew,BreakPipe_order,...
     Dp_Inspect_mat,Dp_Repair_mat,Dp_Travel_mat,...
...
%     disp(['第',num2str(MC_i),'模拟','遗传第',num2str(generation_i),'代','个体',num2str(individual_i)])
    ...
    [Fitness,BreakPipe_result,RepairCrew_result]=fit4...
    (BreakPipePriority,...
    ...
    fitvalue{individual_i,5}=individual_i;
end
disp(['第',num2str(MC_i),'模拟','遗传第',num2str(generation_i),'代'])
fitvalue_sort=sortrows(fitvalue,-1);
best_pop=fitvalue_sort{1,4};
