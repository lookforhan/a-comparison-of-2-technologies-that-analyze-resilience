...
function [pop_isolation_record,Fit_record]...
    =ga_priority7_epanetx64pdd(popsize,generation_length,pc,pm,...种群大小，进化代数，交叉概率，变异概率
    out_dir,....输出目录
    RepairCrew,...修复队伍，
...
for generation_i = 1:generation_length
   ...
   [Fit_uniq,fitvalue]=calfitvalue3(pop_isolation_uniq,BreakPipe_order,RepairCrew,...
