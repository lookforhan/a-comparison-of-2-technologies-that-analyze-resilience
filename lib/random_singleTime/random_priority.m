function [Fitness,pop,BreakPipe_result,RepairCrew_result,...
    ...
    node_calculate_dem,node_calculate_pre,timeStep_end]=random_priority(MC_simulate_result_dir_random,MC_i,...文件夹，模拟次数
...
original_junction_num=numel( node_original_dem);%节点个数
 [Fitness,BreakPipe_result,RepairCrew_result,F,system_L,system_serviceability,node_serviceability,node2_serviceability,node_calculate_dem,node_calculate_pre,timeStep_end]...
     =fit3(pop,RepairCrew,BreakPipe_order,...
