function  [t_W,pipe_relative]=damageNetInp2_E_R(net_data,damage_pipe_info,EPA_format,output_net_filename)
...
[t,all_add_node_data,pipe_new_add]=ND_P_Leak4_E_R(damage_node_data,damage_pipe_info,pipe_new_add);
