...
int DLLEXPORT ENgetcontrol(int, int *, int *, double *, int *, double *);
...
int DLLEXPORT ENgettankvalue(int index, int code, double *value);
int DLLEXPORT ENsettankvalue(int index, int code, double value);
...
// ZK/MSM/JB additions
int DLLEXPORT ENgetwarning(int code, int *value);
int DLLEXPORT ENsetupH(long *);
int DLLEXPORT ENnetsolveH(long *);
int DLLEXPORT ENadddemand(int, double);
int DLLEXPORT ENsetdemand(int, double);
int DLLEXPORT ENgetnodeemittertype(int, int *);
