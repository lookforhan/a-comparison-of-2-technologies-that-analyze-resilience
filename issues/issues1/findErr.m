...
h_name = 'toolkit.h';
object_file = 'time4.inp';
origin_file = 'MOD_5_mean.inp';
fid = 1;
...
[err4,value2] = calllib(lib_name,'ENgettimeparam',1,value2);
...
% 
demand_init = cell2mat(net_data_origin{15,2}(:,2));%初始需水量
...
% 结论：虽然time4计算出现警告信息，但是需水量是满足Wagner调整的。没有大的问题。
% 问题出在其他地方。
